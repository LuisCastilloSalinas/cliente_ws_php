...
$wsdl_url = "http://localhost/service/application/servicio_ejemplo/servicio_factorialSOA.php?wsdl";
$cliente = new Zend_Soap_Client($wsdl_url);
if ( ($_GET['numero'] != "") ) {

?>
<h2> Resultado </h2> <p><?php echo $cliente->factorial($_GET['numero']) ?></p>
...
<form action="cliente_ws_factorial.php" method="get">
